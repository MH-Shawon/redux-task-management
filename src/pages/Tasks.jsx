      ...
      <div className="col-span-9 px-10 pt-10">
        ...
        <div className="grid grid-cols-3 gap-5 mt-10">
          <div className="relative h-[800px] overflow-auto">
            ...
            {
                pendingTask.map((task) => <TaskCard task={task} key={task.id} />)
          ...
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                runningTask.map((task) => <TaskCard key={task.id} task={task} />)
              }
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                doneTask.map((task) => <TaskCard key={task.id} task={task} />)
              }
            </div>
          </div>
        </div>
